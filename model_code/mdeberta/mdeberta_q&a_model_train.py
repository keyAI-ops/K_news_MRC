...
#%%
# 정답 추출
train_data = open('C:\\Users\\ChangKI\\Groom_Project\\project_2\\data\\added_train.json', encoding = 'utf-8')
...
print('CONTEXT : ',df.iloc[[0]]['pharagraph'].values[0])
print()
print('QUESTION : ',df.iloc[[0]]['question'].values[0])
print()
print('ANSWER : ',df.iloc[[0]]['answer'].values[0])
print()
print('ANSWER_START : ',df.iloc[[0]]['answer_start'].values[0])
print()
print('IS IMPOSSIBLE : ',df.iloc[[0]]['is_impossible'].values[0])
#%%
"""# data load"""
...
data
#%%
# squad dataset 전처리 방법을 기계독해 뉴스 데이터셋에 맞게 살짝 변형하여 사용
import collections
...
# model = torch.load('C:\\Users\\ChangKI\\Groom_Project\\project_2\\model_bin\\mdeberta_0206.bin')
model.train
...
for i in range(n_epoch):
    ...
    torch.save(model.state_dict(), 'test_mdeberta_add_korquad{}.bin'.format(i))
